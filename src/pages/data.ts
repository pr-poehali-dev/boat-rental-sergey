...
export const FAQ_ITEMS = [
  { q: "Как забронировать катер или яхту в Саратове?", a: "Оставьте заявку через форму на сайте или позвоните по номеру +7 (927) 118-31-31. Наш менеджер свяжется с вами в течение 15–30 минут, уточнит детали, выберет подходящее судно и закрепит дату. Для подтверждения бронирования вносится предоплата 30% — остаток оплачивается в день выхода." },
  { q: "Сколько стоит аренда катера в Саратове?", a: "Стоимость аренды катера с капитаном начинается от 5 000 ₽/час. Аренда без капитана — от 4 000 ₽/час. Теплоходы для банкетов — от 8 000 ₽/час. Хаусбот — от 15 000 ₽/сутки. В стоимость включены: капитан, топливо, страховка. Точную цену уточняйте у менеджера." },
  { q: "Нужны ли права для аренды катера?", a: "Для аренды катера с капитаном — права не нужны, документы не требуются. Если хотите управлять самостоятельно (аренда катера без капитана), потребуются права ГИМС категории «маломерное судно» и техминимум по безопасности. Мы проводим инструктаж перед выходом." },
  { q: "Можно ли организовать рыбалку на Волге и что включено?", a: "Да, мы организуем рыбалку с профессиональными гидами-рыбаками Саратова. В пакет входят: выезд к лучшим рыбным местам Волги, удочки и снасти, наживка, чистка и разделка улова, горячая уха на берегу. Трофейная рыбалка от 10 000 ₽. Лучшие сезоны: апрель–май и август–октябрь." },
  { q: "Что нужно для романтической прогулки или предложения руки и сердца?", a: "Сообщите нам при бронировании — мы возьмём организацию на себя. Подготовим шампанское, оформим борт цветами и гирляндами, выберем живописный маршрут к закату. Всё делается конфиденциально, сюрприз сохранится. Романтические прогулки на Волге — одна из наших самых востребованных услуг." },
  { q: "Сколько человек вмещает теплоход для банкета?", a: "Наши теплоходы вмещают до 80 гостей. Они оснащены банкетным залом, профессиональной кухней на борту, звуковым и световым оборудованием. Подходят для корпоративов, свадеб, юбилеев. Стоимость аренды теплохода — от 8 000 ₽/час, минимальный заказ — 3 часа." },
  { q: "Возможна ли аренда для вечеринки или дня рождения?", a: "Конечно! Катера и теплоходы — отличный формат для праздника на воде. Можно привезти своего диджея, декор, кейтеринг или заказать у нас. Мы подберём судно под нужное количество гостей — от 2 до 80 человек. Праздник на Волге запоминается лучше любого ресторана." },
  { q: "Что входит в аренду хаусбота на Волге?", a: "Хаусбот — плавучий дом для отдыха: отдельные спальные каюты, полностью оборудованная кухня, санузел с душем, открытая терраса. Вместимость — до 8 человек. Можно стоять у нашего причала или выходить в акваторию Волги. Аренда хаусбота в Саратове от 15 000 ₽/сутки." },
  { q: "Как организуете фотосессию на воде?", a: "Выбираете дату и формат — катер, яхта или хаусбот. Мы строим маршрут вдоль набережной Саратова с видом на мост и исторический центр, подбираем время для лучшего золотого света. Фотограф — ваш или по нашей рекомендации. Средняя продолжительность фотосессии — 2–3 часа." },
  { q: "Что если погода испортится?", a: "При шторме, сильном ветре или грозе мы переносим выход на другую удобную дату без потери предоплаты — 100% суммы сохраняется. Безопасность гостей для нас важнее всего. О переносе предупреждаем минимум за 3 часа. Погодные отмены — редкость: сезон на Волге длится с мая по октябрь." },
  { q: "Где находится причал Volga-Viatek в Саратове?", a: "Наш причал расположен на Лесозаводской улице в районе турбазы Малиновка, Саратов. Удобный подъезд и парковка. Работаем ежедневно с 9:00 до 21:00. Подробный адрес и схему проезда вышлем при подтверждении бронирования — позвоните: +7 (927) 118-31-31." },
];
