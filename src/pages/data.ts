...
export const FAQ_ITEMS = [
  { q: "Нужны ли права для управления катером?", a: "Для аренды катера с капитаном права не нужны. Если вы хотите управлять самостоятельно — необходимы права на управление маломерным судном (ГИМС). Мы поможем с инструктажем." },
  { q: "Есть ли на борту профессиональный капитан?", a: "Да, все суда (кроме аренды без капитана) укомплектованы опытными капитанами с лицензиями ГИМС. Безопасность — наш главный приоритет." },
  { q: "Можно ли взять питомца на борт?", a: "Да, животные допускаются на хаусботы и катера по предварительному согласованию. Просим сообщать об этом при бронировании." },
  { q: "Что делать при плохой погоде?", a: "При ухудшении погодных условий мы переносим выход или предлагаем альтернативную дату. Деньги возвращаются полностью при отмене по погодным причинам." },
  { q: "Как происходит оплата?", a: "Принимаем наличные, банковские карты и переводы. Для бронирования вносится предоплата 30%, остаток — в день выхода на воду." },
];
