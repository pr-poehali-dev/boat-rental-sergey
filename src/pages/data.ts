...
export const REVIEWS = [
  { name: "Александр Морозов", role: "Генеральный директор", rating: 5, text: "Организовали корпоратив на теплоходе. Всё было на высшем уровне — экипаж профессиональный, кухня потрясающая. Однозначно рекомендую!", date: "Май 2025", yacht: "Теплоход" },
  { name: "Екатерина Соколова", role: "Блогер", rating: 5, text: "Арендовали катер для свадебной прогулки по Волге. Это было волшебство — закат на воде, шампанское, полная тишина. Спасибо!", date: "Апрель 2025", yacht: "Катер" },
  { name: "Дмитрий Кузнецов", role: "Предприниматель", rating: 5, text: "Третий год подряд берём хаусбот с семьёй. Невероятный отдых у воды — как свой плавучий дом. Экипаж всегда готов помочь.", date: "Июнь 2025", yacht: "Хаусбот" },
];
